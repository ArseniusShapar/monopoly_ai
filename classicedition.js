...
communityChestCards[13] = new Card("You are assessed for street repairs. $40 per house. $115 per hotel.", function() { streetrepairs(40, 115);});
communityChestCards[14] = new Card("Advance to \"GO\" (Collect $200).", function() { advance(0);});
